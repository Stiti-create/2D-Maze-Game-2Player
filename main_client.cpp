...
LTexture lifedisp, helpdisp, coindisp, lesslife;
LButton create, join;
...
void Dot::move()
{
    ...
    string clientfn_res = clientfn(mPosX, mPosY, myscore, dottype, direction);
    // cout << clientfn_res << endl;
    

    int comma_pos1 = clientfn_res.find(",");
    int comma_pos2 = clientfn_res.find(",", comma_pos1 + 1);
    int comma_pos3 = clientfn_res.find(",", comma_pos2 + 1);
    int comma_pos4 = clientfn_res.find(",", comma_pos3 + 1);

    op_x = stoi(clientfn_res.substr(0, comma_pos1));
    op_y = stoi(clientfn_res.substr(comma_pos1 + 1, comma_pos2 - comma_pos1 - 1));
    opscore = stoi(clientfn_res.substr(comma_pos2 + 1, comma_pos3 - comma_pos2 -1));
    op_dottype = stoi(clientfn_res.substr(comma_pos3 + 1, 1));
    op_direction = stoi( clientfn_res.substr(comma_pos3 + 3, 1) );
...
bool loadMedia()
{
    ...
    // Load dot texture 1
    if (!gDotTexture1.loadFromFile("players/p1d.png"))
    {
    ...
    // Load dot texture 2
    if (!gDotTexture2.loadFromFile("players/p2d.png"))
    {
    ...
    idshowtext.loadFromFile("minnieid.png");
    winpage.loadFromFile("minniewin.png");

    // set positions for buttons heredisp

    // create.setPosition(480, 340);
    join.setPosition(480, 360);
        ...
        else
        {
            ...
            while (!quit)
            {
                ...
                while (SDL_PollEvent(&e) != 0)
                {
                    ...
                    if (e.type == SDL_QUIT)
                    {
                        string clientfn_res = clientfn(0,0,0,0,0);
                        quit = true;
                        gameend = true;
                    }
                ...
                if (dottype == 0)
                {
                    ...
                    {
                    case 1:
                        b = gDotTexture1.loadFromFile("players/p1r.png");

                        break;
                    case 2:
                        b = gDotTexture1.loadFromFile("players/p1u.png");

                        break;
                    case 3:
                        b = gDotTexture1.loadFromFile("players/p1l.png");

                        break;
                    case 4:
                        b = gDotTexture1.loadFromFile("players/p1d.png");
...

                {
                    ...
                    {
                    case 1:
                        b = gDotTexture1.loadFromFile("players/p1ry.png");

                        break;
                    case 2:
                        b = gDotTexture1.loadFromFile("players/p1uy.png");

                        break;
                    case 3:
                        b = gDotTexture1.loadFromFile("players/p1ly.png");

                        break;
                    case 4:
                        b = gDotTexture1.loadFromFile("players/p1dy.png");
                ...
                if (op_dottype == 0)
                {
                    ...
                    {
                    case 1:
                        b = gDotTexture2.loadFromFile("players/p2r.png");

                        break;
                    case 2:
                        b = gDotTexture2.loadFromFile("players/p2u.png");

                        break;
                    case 3:
                        b = gDotTexture2.loadFromFile("players/p2l.png");

                        break;
                    case 4:
                        b = gDotTexture2.loadFromFile("players/p2d.png");
                ...
                else
                {
                    ...
                    {
                    case 1:
                        b = gDotTexture2.loadFromFile("players/p2ry.png");

                        break;
                    case 2:
                        b = gDotTexture2.loadFromFile("players/p2uy.png");

                        break;
                    case 3:
                        b = gDotTexture2.loadFromFile("players/p2ly.png");

                        break;
                    case 4:
                        b = gDotTexture2.loadFromFile("players/p2dy.png");
